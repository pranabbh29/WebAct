...
<CodeGroup>
  ...
  from webact import Agent, ChatBrowserUse
  ...
  from webact import Agent, ChatGoogle
  from dotenv import load_dotenv
  import asyncio
  ...
  from webact import Agent, ChatOpenAI
  from dotenv import load_dotenv
  import asyncio
  ...
  from webact import Agent, ChatAnthropic
  from dotenv import load_dotenv
  import asyncio
...
```python  theme={null}
from webact import Browser, sandbox, ChatBrowserUse
...
```python  theme={null}
from webact import Agent, Browser, ChatBrowserUse
...
```python  theme={null}
from webact import Agent, Browser, ChatOpenAI
...
from webact import Agent, Browser, ChatBrowserUse
from webact.browser import ProxySettings
...
```python  theme={null}
from webact import Tools, ActionResult, BrowserSession
...
```python  theme={null}
from webact import Tools, Agent, ActionResult
