...
from webact.llm.messages import BaseMessage, ContentPartTextParam, SystemMessage
from webact.llm.schema import SchemaOptimizer
from webact.llm.vercel.serializer import VercelMessageSerializer
from webact.llm.views import ChatInvokeCompletion, ChatInvokeUsage
...
class ChatVercel(BaseChatModel):
	...
	Examples:
		```python
	        from webact import Agent, ChatVercel
