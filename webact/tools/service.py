...
from webact.agent.views import ActionModel, ActionResult
from webact.browser import BrowserSession
...
from webact.browser.views import BrowserError
from webact.dom.service import EnhancedDOMTreeNode
...
from webact.tools.registry.service import Registry
from webact.tools.utils import get_click_description
from webact.tools.views import (
	ClickElementAction,
...
from webact.utils import create_task_with_error_handling, sanitize_surrogates, time_execution_sync
	...
	def __init__(
		...
		async def extract(
			...
			if output_schema is not None:
				try:
					from webact.tools.extraction.schema_utils import schema_dict_to_pydantic_model
			...
			from webact.dom.markdown_extractor import chunk_markdown_by_structure
...
""".strip()
				...
				try:
					...
					from webact.tools.extraction.views import ExtractionResult
...
""".strip()
		...
		async def select_dropdown(params: SelectDropdownOptionAction, browser_session: BrowserSession):
			...
			from webact.browser.events import SelectDropdownOptionEvent
