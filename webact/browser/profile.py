...
from webact.browser.cloud.views import CloudBrowserParams
from webact.config import CONFIG
from webact.utils import _log_pretty_path, logger
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
	...
	proxy: ProxySettings | None = Field(
		default=None,
		description='Proxy settings. Use webact.browser.profile.ProxySettings(server, bypass, username, password)',
	)
