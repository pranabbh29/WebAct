...
def handle(yes: bool = False) -> dict:
	...
	from webact.skill_cli.profile_use import get_profile_use_binary
...
def _check_package() -> str:
	...
	try:
		...
		version = getattr(webact, '__version__', 'unknown')
...
def _install_profile_use() -> bool:
	...
	try:
		from webact.skill_cli.profile_use import download_profile_use
