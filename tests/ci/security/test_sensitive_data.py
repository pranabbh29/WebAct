...
from webact.agent.message_manager.service import MessageManager
from webact.agent.views import ActionResult, AgentOutput, AgentStepInfo, MessageManagerState
from webact.browser.views import BrowserStateSummary
from webact.dom.views import SerializedDOMState
from webact.filesystem.file_system import FileSystem
from webact.llm import SystemMessage, UserMessage
from webact.llm.messages import ContentPartTextParam
from webact.tools.registry.service import Registry
from webact.utils import is_new_tab_page, match_url_with_domain_pattern
...
def test_password_field_value_excluded_from_dom_snapshot():
	...
	"""
	from webact.dom.serializer.serializer import DOMTreeSerializer
	from webact.dom.views import DEFAULT_INCLUDE_ATTRIBUTES
