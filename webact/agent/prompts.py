...
from webact.dom.views import NodeType, SimplifiedNode
from webact.llm.messages import ContentPartImageParam, ContentPartTextParam, ImageURL, SystemMessage, UserMessage
from webact.observability import observe_debug
from webact.utils import is_new_tab_page, sanitize_surrogates

if TYPE_CHECKING:
	from webact.agent.views import AgentStepInfo
...
class SystemPrompt:
	...
	def _load_prompt_template(self) -> None:
		...
		try:
			...
			with (
				importlib.resources.files('webact.agent.system_prompts')
