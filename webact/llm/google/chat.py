...
from webact.llm.exceptions import ModelProviderError
from webact.llm.google.serializer import GoogleMessageSerializer
...
class ChatGoogle(BaseChatModel):
	...
	def logger(self) -> logging.Logger:
		...
		return logging.getLogger(f'webact.llm.google.{self.model}')
